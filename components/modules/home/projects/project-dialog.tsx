...
import { type GhRepo, octokit } from "@/services/octokit";
import { Transition, Dialog } from "@headlessui/react";
import Image from "next/image";
import React, { Fragment, useMemo } from "react";
import { LuFileCode2, LuGlobe, LuX } from "react-icons/lu";
									...
									<div className="flex items-center gap-2">
										{project.homepage && (
											<Link href={project.homepage} target="_blank">
												<button
													type="button"
													className="flex flex-col items-center p-4 rounded-full transition-all hover:brightness-90 active:scale-95 hover:bg-background/80"
												>
													<LuGlobe />
										...
										<Link href={project.html_url} target="_blank">
											<button
												type="button"
												className="flex gap-1 justify-center items-center bg-secondary-background-dark dark:bg-secondary-background text-white dark:text-gray-900 transition-all px-6 py-2 rounded-full hover:brightness-90 active:scale-90 text-sm"
											>
												<span>Source</span>
												<LuFileCode2 />
											</button>
